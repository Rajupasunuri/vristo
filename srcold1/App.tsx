...
function App({ children }: PropsWithChildren) {
    ...
    useEffect(() => {
        dispatch(toggleStudentLoginDtls({
            ...
            username: localStorage.getItem('username') || themeConfig.username,
            school_address: localStorage.getItem('school_address') || themeConfig.school_address,
    ...
    }, [dispatch, themeConfig.schoolyearID, themeConfig.studentID, themeConfig.username, themeConfig.school_address, themeConfig.school_appname, themeConfig.school_phone, themeConfig.school_addphone, themeConfig.school_email, themeConfig.invoice_type, themeConfig.classesID, themeConfig.sectionID, themeConfig.classname, themeConfig.sectionname, themeConfig.user_type, themeConfig.std_name, themeConfig.std_email, themeConfig.std_phone, themeConfig.std_roll, themeConfig.std_photo, themeConfig.std_dob, themeConfig.std_regno]);

...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        toggleStudentLoginDtls(state, { payload }: PayloadAction<string | undefined | any>) {
            ...
            localStorage.setItem("studentID", studentdtls.id);
            localStorage.setItem("username", studentdtls.username);
            localStorage.setItem("school_address", studentdtls.school_address);
            ...
            state.username = studentdtls.username;
            state.school_address = studentdtls.school_address;
        ...
        logout: (state) => {
            ...
            localStorage.setItem('school_address', '');

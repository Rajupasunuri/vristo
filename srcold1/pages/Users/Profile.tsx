...
const Profile = () => {
    ...
    const username = useSelector((state: IRootState) => state.themeConfig.username);
                        ...
                        {profileinfobox ? (
                            <>
                                <div className="panel">
                                    ...
                                    <div className="mb-5">
                                        <div className="flex flex-col justify-center items-center">
                                            <img src={std_photo} alt="img" className="w-48 h-46 md:w-37 md:h-35  overflow-hidden  object-cover  mb-5" />
                                ...
                                ></Uploadfile> */}
                                            ...
                                            <p className="font-semibold text-primary  text-xl">{std_name}</p>
                                            <p className="font-semibold text-primary  text-sm">Date of Birth:{std_dob}</p>
                                        </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row">
                                        <div className="ltr:sm:mr-4 rtl:sm:ml-4 w-full sm:w-2/12 mb-5">
                                            ...
                                            <label htmlFor="imageInput" style={{ cursor: 'pointer' }}>
                                                <img src={std_photo} alt="img" className="w-20 h-18 md:w-31 md:h-28  object-cover mx-auto" />
                                            </label>
                                        </div>

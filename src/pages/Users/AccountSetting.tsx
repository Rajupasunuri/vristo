                            ...
                            <div className="flex flex-col sm:flex-row">
                                ...
                                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input id="name" type="text" placeholder="Jimmy Turner" value="Joe Doe" className="form-input" />
                                    </div>
                                    <div>
                                        <label htmlFor="profession">Profession</label>
                                        <input id="profession" type="text" placeholder="Web Developer" value={yes3} className="form-input" />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input id="phone" type="text" placeholder="+1 (530) 555-12121" value={yes2} className="form-input" />
                                    </div>
                                    <div>
                                        <label htmlFor="email">Email</label>
                                        <input id="email" type="email" placeholder="Jimmy@gmail.com" value={yes} className="form-input" />
                                    </div>
                                    <div>

...
export const Uploadfile = (props) => {
  ...
  return (
    <>
      ...
      <div> <input type="button" onClick={()=>{fileUpload();closeModal();isUploaded()}} className="submit" value="upload" style={{display:'flex',justifyContent:'flex-end',border:'1px solid grey',margin:'10px 0px',padding:'1px', color:"white",backgroundColor:'pink'}} />
      </div> 
      <div>{upload}</div>
      </Modal>
      {/* <div className="card" onClick={openModal}>

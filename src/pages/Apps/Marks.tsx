...
const Marks = () => {
    ...
    //     }
    // };
    const loadyearexam = (schyearid: any, yearstdid: any,yearclassesID:any,yearsectionID:any) => {
        ...
        <>
            {invoLoader ? (
                ...
                <div className="panel ">
                        ...
                        {stdYears.map((year: any, index: number) => (
                            <div key={index}>
                                <button
                                    ...
                                    onClick={() => loadyearexam(year.schoolyearID, year.studentID,year.classesID,year.sectionID)}
                                >
                                    {year.schoolyear}
                                </button>
                            </div>
                    ...
                    {exams.length>=1?<div className="card-container">
  ...
  {exams.map((exam: any, index: number) => {
    ...
    const totalActual = ex_subjects.reduce((acc, sub) => {

        if(!isNaN(sub.actual)){
            acc + Number(sub.actual)
        }
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border px-4 py-2"></td>
                 ...
                 <h2 className="text-lg font-semibold flex justify-center items-center">No Exam Conducted</h2>
